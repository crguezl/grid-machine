...
/* ------------------------------------------------------
 * Escribe en pantalla el contenido de una matriz, en le 
 * mismo formato que el de entrada: La primera linea contiene
 * 2 enteros positivos, numero de filas y columnas separados
 * por un espacio. Las siquientes lineas contienen flotantes
 * separados por espacios (cada fila es terminada con un retorno 
 * de carro).
   ------------------------------------------------------ */
void matrix_print(matrix_t *m)
{
	...
	for (row = m->start; row < m->end; row++) {
		for (col = 0; col < m->cols; col++)
			printf(STR_ELEM, m->data[row][col]);
